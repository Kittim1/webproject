...
<html>
<head>
	<link rel="shortcut icon" type="png" href="images/icon/logoo.png">
	<title>Computer Science Courses on Elearning</title>
...
<!-- MAIN Heading of Page -->
	<div class="title">
		<span>Information Techlogy Courses<br>on Elearning</span>
		<div class="shortdesc">
...
<!-- Some KeyWords related to Topic -->
	<div class="course">
		...
		<div class="det"><a href="https://www.spiceworks.com/tech/devops/articles/object-oriented-programming/#:~:text=Object%2Doriented%20programming%20(OOP)%20is%20defined%20as%20a%20programming,the%20usual%20logic%2Dbased%20system.">Object Oriented Programming</a></div>
		<div class="det"><a href="https://medium.com/@sadatnazrul/computer-networking-1-introduction-dfecd667693d">Networking 1</a></div>
		<div class="det"><a href="https://www.spiceworks.com/tech/artificial-intelligence/articles/what-is-hci/">Human Computer Interaction 1 </a></div>
		<div class="det"><a href="https://www.tutorialspoint.com/php/index.htm">Php</a></div>
		</div>
	</div>
...
<!-- Courses Available -->
	<div class="inbt">
		Accelerate your career with free tutorial about any languages.
	</div>
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="image/closeparenthesis.png"></div>
				<a href="#projects"><div class="spart">2 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/java-course.jpg"></div>
				<a href="#java"><div class="spart">2 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/python-course.png"></div>
				<a href="#python"><div class="spart">5 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/c-course.jpg"></div>
				<a href="#c++"><div class="spart">3 Courses <img src="image/dropdown.png"></div></a>
			</div>
		</div>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="image/web-course.jpg"></div>
				<a href="#html_css"><div class="spart">6 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/data-course.jpg"></div>
				<a href="#data"><div class="spart">2 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/algo-course.jpg"></div>
				<a href="#algo"><div class="spart">1 Courses <img src="image/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="image/php.png"></div>
				<a href="#algo"><div class="spart">1 Courses <img src="image/dropdown.png"></div></a>
...
<!-- Videos on C++ Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/c-course.jpg">
...
<!-- Videos on PYTHON Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/python-course.png">
...
<!-- Videos on DATA STRUCTURES Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/data-course.jpg">
...
<!-- Videos on ALGORITHM Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/algo-course.jpg">
...
<!-- Videos on HTML and CSS Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/web-course.jpg">
...
<!-- Videos on JAVASCRIPT Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/javascript-course.jpg">
...
<br><br>
	...
	<div class="title2" id="php">
		<span>Start Practicing Php</span>
		<div class="shortdesc2">
			<p>Use this to build great projects and database for back-end</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=m52ljs78S24&list=PL0eyrZgxdwhwwQQZA79OzYwl5ewA7HQih" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >2/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=KgUp3FomMoc&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=3" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >3/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src=https://www.youtube.com/watch?v=HrtS-FkPBqk&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >4/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=6JtP8xk1U_k&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=5" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		
			<div class="dcard2"><span class="tag" >5/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=KH4MmQsCDuw&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=6" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >6/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=1kO_g_ucYCQ&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=7" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >7/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtube.com/watch?v=rjEP_GUdg6o&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="dcard2"><span class="tag" >8/8</span>
				<div class="fpart2"><img src="image/php.png">
					<iframe src="https://www.youtu	be.com/watch?v=d3c_OOD4Jzs&list=PLr3d3QYzkw2xabQRUpcZ_IBk9W50M9pe-&index=9" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</center>
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=zZ6vybT1HQs" target="_blank">Click Here to Watch full playlist</a>
	</div>
...
<!-- PROJECTS -->
	...
	<div class="project-panel">
		<div class="project-card">
			<img src="image/closeparenthesis.png">
			<div class="info">
				<h4>SUDOKO</h4><p>Simple Multiplayer Game with Source Code is a project that is a multi-player game where your goal is to compete to each other to determine the winner. </p>
				<div class="download"><a href="https://www.sourcecodester.com/htmlcss/15287/simple-multiplayer-game-using-pure-css-free-source-code.html" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			<img src="image/closeparenthesis.png">
			<div class="info">
				<h4>FOOD WEBSITES</h4><p>This Website helps you to manage your Personal Photos developed using HTML, CSS & JavaScript</p>
				<div class="download"><a href="https://www.sourcecodester.com/htmlcss/15336/food-website-templates-free-download-html-css.html" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			<img src="image/closeparenthesis.png">
			<div class="info">
				<h4>REGISTER FORM HTML & CSS</h4><p>This Website helps you in your favorite Sports made using HTML, CSS & JavaScript</p>
				<div class="download"><a href="https://www.sourcecodester.com/htmlcss/15644/multi-step-registration-form-html-javascript-css.html" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			<img src="image/closeparenthesis.png">
			<div class="info">
				<h4>COMPANIES HTML & CSS</h4><p>This Website helps you in your favorite Sports made using HTML, CSS & JavaScript</p>
				<div class="download"><a href="https://www.sourcecodester.com/htmlcss/16366/single-page-website-companies-using-htl-css-and-js-source-code-free-download.html" target="_blank">Download</a></div>
			</div>
		</div>
		...
		<div class="project-card">
			<img src="image/closeparenthesis.png">
			<div class="info">
				<h4>FQS HTML & CSS</h4><p>This Website helps you in your favorite Sports made using HTML, CSS & JavaScript</p>
				<div class="download"><a href="https://www.sourcecodester.com/htmlcss/16997/faqs-page-using-html-css-and-javascript-source-code.html" target="_blank">Download</a></div>
			</div>
		</div>
