...
<title>Hello || E-Learning Exam</title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand"href="camera.php"><b>Camera</b></a>
      <a class="navbar-brand"href="feedback.php"><b>Feedback</b></a>
    </div>
...
<!-- <div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <h4 style="font-family:'typo' ">INFORMATION TECHNOLOGY</h4></div></div>
    </p>
      </div>
      ...
      <div class="col-md-5">
    <a href="https://www.facebook.com/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">VAN MORRE A.GUANGCO</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">09972664749</h4>
    <h4 style="font-family:'typo' ">VAAC.GUANGCO.COC@PHINMAED.COM</h4>
    <h4 style="font-family:'typo' ">INFORMATION TECHNOLOGY</h4></div></div>
    </p>
      </div> -->
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:orange;font-family:'open-sans' ">LOGIN</span></h4>
      </div>
